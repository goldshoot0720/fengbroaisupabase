...
- **鋒兄工具**：BigGo 比價、手動價錢紀錄、手機通路比價、YouTube、金融報價、鋒兄新聞、圖片語音成片、圖片格式轉換（參考 PNGJPEGConverter）、影片合併（參考 VideoMerge）、YT／B站轉 MP3／MP4（參考 YoutubeBilibiliMP4MP3Converter，需本機 yt-dlp）

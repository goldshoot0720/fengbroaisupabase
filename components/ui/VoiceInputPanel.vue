...
const pageAliases = {
  ...
  music: ['音樂', '歌曲', '歌', '鋒兄音樂', '音樂播客', '鋒兄音樂/播客', 'music'],
  document: ['文件', '檔案', '文檔', '資料夾', '鋒兄文件', 'document'],
  podcast: ['播客', 'podcast', '節目', '訪談', '鋒兄播客'],
  bank: ['銀行', '帳戶', '存款', '金融', '鋒兄銀行', '票證', '點數', 'bank'],
  routine: ['例行', '流程', '任務', '固定流程', '鋒兄例行', 'routine'],
  tools: ['工具', '比價', '手機比價', '鋒兄工具', '鋒兄新聞', '新聞', '圖片轉換', '格式轉換', '影片合併', '合併影片', '轉檔', 'bilibili', 'youtube', 'tools'],
  settings: ['設定', '系統設定', '來源設定', '偏好設定', '鋒兄設定', '設定關於', '鋒兄設定/關於', 'settings'],
...
const pageHints = {
  ...
  tools: ['搜尋 Samsung 26', '手機比價', '鋒兄比價', '鋒兄新聞'],

...
export default defineNuxtConfig({
  ...
  pwa: {
    ...
    manifest: {
      name: '鋒兄AI Appwrite',
      short_name: '鋒兄AI',
      description: '鋒兄AI Appwrite - 專業的訂閱、食物、影片和圖片管理平台',
      theme_color: '#3b82f6',
